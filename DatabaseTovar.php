...
$query1 = 'SELECT requests.id, offers.name, requests.price, requests.count, operators.fio FROM operators
...
$query2 = 'SELECT offers.name, requests.count, requests.price FROM offers
